...
Route::middleware('auth')->group(function() {
    ...
    Route::middleware('can:admin')->group(function(){
        ...
        Route::delete('index',[LogActivityController::class,'clear'])->name('log.clear');
    ...
    Route::middleware('can:admin-kasir')->group(function() {
        ...
        Route::get('transaksi/member/{member}/paket/{paket}', [TransaksiController::class,'updateCart'])->name('transaksi.updateCart');
    });
    ...
    Route::middleware('can:admin-owner')->group(function(){
        ...
        Route::get('index',[LogActivityController::class,'index'])->name('log.index');
    });
